class History_in_space():
    ...
    def year_2011(self):
        print("Events occurred in the feild of space in 2011")
class History_in_medical():
    ...
    def year_2011(self):
        print("Events occurred in the feild of medical in 2011")
class History_in_sports():
    ...
    def year_2011(self):
        print("Events occurred in the feild of sports in 2011")
